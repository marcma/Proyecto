...
function presionTecla(e){
  ...
  conexion1.open('GET','../encuesta/ordena_e_ajax.php?text='+document.form1.buscar.value+"&radio1="+document.form1.radio1.checked+
...
function procesarEventos(){
  var resultados = document.getElementById("resultado1");
