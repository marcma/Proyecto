...
<html>
	...
	<body>
		<form action="./moduloitems/controladores/itemsControlador.php" name="myform" id="myform" cellspacing="2" cellpadding="2" method="POST" onSubmit="return valida()">
			<table>				
				<tr>					
					<td>Usuario:</td>
					<td>
				...
				<tr>
					...
					<td>
						...
						<input type="text" name="password" size="20" maxlength="30" />
					</td>
				</tr>
				<tr>					
					<td>Nombre:</td>					
				...
				<tr>
					...
					<td>
						...
						<input type="text" name="apellido1" size="20" maxlength="30" />
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<input type="text" name="apellido2" size="20" maxlength="30" />
					</td>
				</tr>
				<tr>
					<td>Edad:</td>			
					<td>
						...
						<input type="text" name="edad" size="20" maxlength="30" />
					</td>
				</tr>		
				<tr>
					<td>Dirección:</td>				
					<td>
						...
						<input type="text" name="direccion" size="20" maxlength="30" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<div id='myform_dni_errorloc' class="error_strings"></div>	
						<input type="text" name="dni" size="20" maxlength="30" />
					</td>
				</tr>
				<tr>					
					<td>Email:</td>				
			...
			<script language="JavaScript" src="./moduloitems/js/valAlta.js" type="text/javascript" xml:space="preserve"></script>
		</form>
	</body>
</html>