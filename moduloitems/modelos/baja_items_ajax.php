		...
		$cadena.= '<br>';$cadena.= '<br>';$cadena.= '<br>';$cadena.= '<br>';
			...
			while ($obj = $resultado->fetch_object()){
				...
				$cadena.='<tr class="impar color">';
					...
					$cadena.= '<td align="right"><a href="../../Proyecto MVC/moduloitems/controladores/itemsControlador.php?id='.$obj->usuario .																										
																											'">Eliminar</a>'.'</td>';
					
					/*$cadena.= '<td align="right"><a href="./moduloitems/controladores/itemsControlador.php?id='.$obj->usuario .
