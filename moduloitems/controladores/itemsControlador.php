...
if( isset($_GET['idd'],$_GET['pass'],$_GET['nombre'],$_GET['apellido1'],$_GET['apellido2'],$_GET['edad'],$_GET['direccion'],$_GET['telefono'],$_GET['dni'],$_GET['email'],$_GET['tipo'])  ){
	echo $_GET['nombre'];
/*
	require '../../modelo/conexion.php';
	require '../modelos/itemsModelo.php';
	...
	*/
	...
	//echo $_GET['idd'],$_GET['pass'],$_GET['nombre'],$_GET['apellido1'],$_GET['apellido2'],$_GET['edad'],$_GET['direccion'],$_GET['telefono'],$_GET['dni'],$_GET['email'],$_GET['tipo'];
