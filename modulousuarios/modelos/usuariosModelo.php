...
function altaUsuarios($usuario1,$password,$nombre,$apellido1,$apellido2,$edad,$direccion,$telefono,$dni,$email,$tipo){
	global $servidor, $bd, $usuario, $contrasenia;
	try{
		@ $db = new mysqli($servidor, $usuario, $contrasenia);
		if (mysqli_connect_errno() != 0)
...
function bajaUsuarios($usuario1){
	global $servidor, $bd, $usuario, $contrasenia;
	try{
		@ $db = new mysqli($servidor, $usuario, $contrasenia);
		if (mysqli_connect_errno() != 0)
...
/////////////////////////////////////////////////
function modificarUsuarios($usuario1,$password,$nombre,$apellido1,$apellido2,$edad,$direccion,$telefono,$dni,$email,$tipo){
	global $servidor, $bd, $usuario, $contrasenia;
	try{
		@ $db = new mysqli($servidor, $usuario, $contrasenia);
		if (mysqli_connect_errno() != 0)
