var frmvalidator  = new Validator("myform");
	...
	frmvalidator.addValidation("usuario","maxlen=30","La maxima longitud permitida es 30 caracteres");
	
	frmvalidator.addValidation("password","req","Por favor introduzca su contrasena");
	frmvalidator.addValidation("password","minlength=4","La minima longitud permitida es 4 caracteres");
	frmvalidator.addValidation("password","maxlen=30","La maxima longitud permitida es 30 caracteres");
	
	frmvalidator.addValidation("nombre","req","Por favor introduzca su nombre");
	frmvalidator.addValidation("nombre","alphabetic_space","Solo se aceptan caractereses alfabeticos");
	...
	frmvalidator.addValidation("apellido1","alphabetic_space","Solo se aceptan caractereses alfabeticos");
	...
	frmvalidator.addValidation("apellido2","alphabetic_space","Solo se aceptan caractereses alfabeticos");
	...
	frmvalidator.addValidation("telefono","numeric","Solo se aceptan caracteres numericos");
	...
	frmvalidator.addValidation("email","maxlen=45", "La maxima longitud permitida es 45 caracteres");
