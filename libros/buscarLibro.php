	...
	<body>
		...
		<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
			<TABLE>
				<TR>
					<TD>Código libro:</TD>
					<TD><INPUT TYPE="text" NAME="codLibro" SIZE="20" MAXLENGTH="30"></TD>
				</TR>
			</TABLE>
		...
		try{
			...
			$consulta = "select codLibro,titulo,nombreAutor,apellido1Autor,apellido2Autor,tema,unidades,isbn,numPaginas from libros where codLibro='".$codLibro."'";
