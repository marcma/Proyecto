		...
		$cadena.= '<br>';$cadena.= '<br>';$cadena.= '<br>';$cadena.= '<br>';
			...
			while ($obj = $resultado->fetch_object()){
				...
				$cadena.='<tr class="impar color">';
					...
					$cadena.= '<td align="right"><a href="index2.php?controlador=items&accion=modificar2&param='.$obj->usuario .
																										'">Modificar</a>'.'</td>';
					
					/*$cadena.= '<td align="right"><a href="./moduloitems/modelos/modifica_items_ajax1.php?idd='.$obj->usuario .
																										'&pass='.$obj->password .
																										'&nombre='.$obj->nombre .
				...
				if ($obj = $resultado->fetch_object()){
					...
					$cadena.='<tr class="par color">';
						...
						$cadena.='<td align="center">'.$obj->email.'</td>';
						$cadena.='<td align="center">'.$obj->tipo.'</td>';
						//<li><a href="./index2.php?controlador=items&accion=modificar2&">Modificar</a></li>
						$cadena.= '<td align="right"><a href="index2.php?controlador=items&accion=modificar2&param='.$obj->usuario .																								
																											'">Modificar</a>'.'</td>';
					$cadena.='</tr>';				
