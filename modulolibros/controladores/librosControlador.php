...
if( isset($_POST['codLibro'])  ){
	...
	altaLibros($_POST['codLibro'],$_POST['titulo'],$_POST['nombreAutor'],$_POST['apellido1Autor'],$_POST['apellido2Autor'],$_POST['tema'],$_POST['unidades'],$_POST['isbn'],$_POST['numPaginas']);
	$libros = buscarTodosLosItems();
...
//echo $_GET['idd'];
	require '../../modelo/conexion.php';
	require '../modelos/librosModelo.php';
	modificarLibros($_GET['idd'],$_GET['titulo'],$_GET['nombreAutor'],$_GET['apellido1Autor'],$_GET['apellido2Autor'],$_GET['tema'],$_GET['unidades'],$_GET['isbn'],$_GET['numPaginas']);	
	$libros = buscarTodosLosItems();
	header("Location: ../../index2.php?controlador=libros&accion=listar");	
	//?>
