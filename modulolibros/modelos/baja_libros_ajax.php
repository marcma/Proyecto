	...
	if ($resultado->num_rows > 0){
		$cadena.= '<br>';$cadena.= '<br>';$cadena.= '<br>';$cadena.= '<br>';
			...
			$cadena.='<tr>';
				...
				$cadena.='<th>ISBN</th>';
				$cadena.='<th>Número de páginas</th>';	
			$cadena.='</tr>';
			...
			while ($obj = $resultado->fetch_object()){
				...
				$cadena.='<tr class="impar color">';
					...
					$cadena.= '<td align="right"><a href="./modulolibros/controladores/librosControlador.php?id='.$obj->codLibro .'">Eliminar</a>'.'</td>';				
				$cadena.='</tr>';
